...
const ShareArticle = ({ title, slug }) => {
  ...
  let productSlug = `https://danblogs.vercel.app/blog/${slug}/`;

  let twitterShareString = `https://twitter.com/intent/tweet?text=I'm currently reading 👉 ${title}&url=${productSlug} via @micodan`;
  return (
